...
Source brand images live in `assets/img/`.
...
This copies and renames all files into `public/images/` for the Next.js site.

## File mapping

| Source (`assets/img/`) | Web path (`public/images/`) |
|------------------------|-----------------------------|
...
| `p1.jpg`, `v1.jpg`–`v4.jpg` | same names |
